...
public class App extends Application {
    ...
    public void showScene1() {
        ...
        masuk.setOnAction(e -> {
            ...
            String inputNope = nope.getText();
            nope2 = inputNope;

            showScene2();
        });

        VBox vbox = new VBox(nama, namaa, nohp, nope, masuk);
    ...
    public void showScene2() {
        ...
        mulai.setOnAction(e -> showScene3());
        Scene scene2 = new Scene(root, 500, 620);
        stage.setScene(scene2);
    }

    public void showScene2Part1() {
        Image image = new Image("/moderncanteen.png");
        ImageView imageView = new ImageView(image);
        imageView.setFitHeight(620);
        StackPane root = new StackPane();
        ...
        mulai.setOnAction(e -> showScene4(stage, namaa2, nope2));
    ...
    public void showScene3() {
        ...
        next.setOnAction(e -> showScene4(stage, namaa2, nope2));
    ...
    public void showScene4(Stage stage, String namaa2, String nope2) {
        ...
        backtohome.setOnAction(e -> showScene2Part1());
        ...
        backtohome.setOnAction(v -> showScene2());
